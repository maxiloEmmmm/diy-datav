...
func (uq *UserQuery) QueryShare() *ShareQuery {
	query := &ShareQuery{config: uq.config}
...
func (uq *UserQuery) sqlAll(ctx context.Context) ([]*User, error) {
	...
	if query := uq.withShare; query != nil {
		...
		query.Where(predicate.Share(func(s *sql.Selector) {
			s.Where(sql.InValues(user.ShareColumn, fks...))
		}))
		...
		for _, n := range neighbors {
			fk := n.user_share
			if fk == nil {
				return nil, fmt.Errorf(`foreign-key "user_share" is nil for node %v`, n.ID)
			}
			node, ok := nodeids[*fk]
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "user_share" returned %v for node %v`, *fk, n.ID)
			}
...
func (ugb *UserGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(ugb.fields) > 1 {
		return nil, errors.New("model: UserGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := ugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ugb *UserGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("model: UserGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ugb *UserGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(ugb.fields) > 1 {
		return nil, errors.New("model: UserGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := ugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ugb *UserGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("model: UserGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ugb *UserGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(ugb.fields) > 1 {
		return nil, errors.New("model: UserGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := ugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ugb *UserGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("model: UserGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ugb *UserGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(ugb.fields) > 1 {
		return nil, errors.New("model: UserGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := ugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ugb *UserGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("model: UserGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (us *UserSelect) Strings(ctx context.Context) ([]string, error) {
	if len(us.fields) > 1 {
		return nil, errors.New("model: UserSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := us.Scan(ctx, &v); err != nil {
		return nil, err
...
func (us *UserSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("model: UserSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (us *UserSelect) Ints(ctx context.Context) ([]int, error) {
	if len(us.fields) > 1 {
		return nil, errors.New("model: UserSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := us.Scan(ctx, &v); err != nil {
		return nil, err
...
func (us *UserSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("model: UserSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (us *UserSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(us.fields) > 1 {
		return nil, errors.New("model: UserSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := us.Scan(ctx, &v); err != nil {
		return nil, err
...
func (us *UserSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("model: UserSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (us *UserSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(us.fields) > 1 {
		return nil, errors.New("model: UserSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := us.Scan(ctx, &v); err != nil {
		return nil, err
...
func (us *UserSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{user.Label}
	default:
		err = fmt.Errorf("model: UserSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
